document.addEventListener('DOMContentLoaded', () => {
    ...
    function checkIfAdmin() {
        ...
        axios.get('https://recipe-management-n4a8e0net-kautilya-tiwaris-projects.vercel.app/user/isAdmin', { headers: { 'authorization': token } })
            .then(response => {
    ...
    function loadAllRecipes() {
        axios.get('https://recipe-management-n4a8e0net-kautilya-tiwaris-projects.vercel.app/recipes')
        .then(response => {
    ...
    function saveToFavorites(recipeId) {
        const token = localStorage.getItem('token');
        axios.post(`https://recipe-management-n4a8e0net-kautilya-tiwaris-projects.vercel.app/user/favorites`, { recipeId }, { headers: { 'authorization': token } })
        .then(() => {
    ...
    function showCollectionSelector(recipeId) {
        const token = localStorage.getItem('token');
        axios.get('https://recipe-management-n4a8e0net-kautilya-tiwaris-projects.vercel.app/user/collections', { headers: { 'authorization': token } })
        .then(response => {
    ...
    function addToCollection(collectionId, recipeId) {
        const token = localStorage.getItem('token');
        axios.post(`https://recipe-management-n4a8e0net-kautilya-tiwaris-projects.vercel.app/user/collections/${collectionId}/recipes`, { recipeId }, { headers: { 'authorization': token } })
        .then(() => {
    ...
    function rateRecipe(recipeId, rating) {
        const token = localStorage.getItem('token');
        axios.post(`https://recipe-management-n4a8e0net-kautilya-tiwaris-projects.vercel.app/recipes/${recipeId}/rate`, { rating }, { headers: { 'authorization': token } })
        .then(() => {
    ...
    function reviewRecipe(recipeId, reviewText) {
        const token = localStorage.getItem('token');
        axios.post(`https://recipe-management-n4a8e0net-kautilya-tiwaris-projects.vercel.app/recipes/${recipeId}/review`, { text: reviewText }, { headers: { 'authorization': token } })
        .then(() => {
    ...
    function loadReviewsAndRatingsForRecipes(recipeIds) {
        recipeIds.forEach(recipeId => {
            axios.get(`https://recipe-management-n4a8e0net-kautilya-tiwaris-projects.vercel.app/recipes/${recipeId}/details`)
            .then(response => {
                const data = response.data;
    ...
    function handleRecipeSubmit(event) {
        ...
        axios.post('https://recipe-management-n4a8e0net-kautilya-tiwaris-projects.vercel.app/user/recipe', {
            title,
            ingredients,
            instructions,
            imageUrl,
    ...
    function loadFilteredRecipes() {
        ...
        axios.get('https://recipe-management-n4a8e0net-kautilya-tiwaris-projects.vercel.app/filtered/recipes', {
            params: {
                search,
                dietary,
                difficulty,
    ...
    function loadUserProfile() {
        const token = localStorage.getItem('token');
        axios.get('https://recipe-management-n4a8e0net-kautilya-tiwaris-projects.vercel.app/user/profile', { headers: { 'authorization': token } })
        .then(response => {
    ...
    function loadContributedRecipes() {
        const token = localStorage.getItem('token');
        axios.get('https://recipe-management-n4a8e0net-kautilya-tiwaris-projects.vercel.app/user/profile/contributed', { headers: { 'authorization': token } })
        .then(response => {
            const data = response.data;
    ...
    function deleteRecipe(recipeId) {
        const token = localStorage.getItem('token');
        axios.delete(`https://recipe-management-n4a8e0net-kautilya-tiwaris-projects.vercel.app/recipes/${recipeId}`, { headers: { 'authorization': token } })
        .then(response => {
    ...
    function editRecipe(recipeId) {
        ...
        axios.get(`https://recipe-management-n4a8e0net-kautilya-tiwaris-projects.vercel.app/recipes/${recipeId}`, { headers: { 'authorization': token } })
        .then(response => {
    ...
    function handleRecipeEditSubmit(recipeId) {
        ...
        axios.put(`https://recipe-management-n4a8e0net-kautilya-tiwaris-projects.vercel.app/recipes/${recipeId}`, {
            title,
            ingredients,
            instructions,
            imageUrl,
    ...
    function loadFavoriteRecipes() {
        const token = localStorage.getItem('token');
        axios.get('https://recipe-management-n4a8e0net-kautilya-tiwaris-projects.vercel.app/user/favorites', { headers: { 'authorization': token } })
        .then(response => {
            const data = response.data;
    ...
    function removeFromFavorites(recipeId) {
        const token = localStorage.getItem('token');
        axios.delete(`https://recipe-management-n4a8e0net-kautilya-tiwaris-projects.vercel.app/user/favorites/${recipeId}`, { headers: { 'authorization': token } })
        .then(() => {
    ...
    function handleProfileUpdate(event) {
        ...
        axios.put('https://recipe-management-n4a8e0net-kautilya-tiwaris-projects.vercel.app/user/profile', {
            name,
            email,
            password
        }, { headers: { 'authorization': token } })
    ...
    function createCollection() {
        ...
        const token = localStorage.getItem('token');
        axios.post('https://recipe-management-n4a8e0net-kautilya-tiwaris-projects.vercel.app/user/collections', { name: collectionName }, { headers: { 'authorization': token } })
        .then(() => {
    ...
    function viewCollection(collectionId) {
        const token = localStorage.getItem('token');
        axios.get(`https://recipe-management-n4a8e0net-kautilya-tiwaris-projects.vercel.app/user/collections/${collectionId}`, { headers: { 'authorization': token } })
        .then(response => {
            const data = response.data;
    ...
    function loadAllUsers() {
        ...
        `;
        const token = localStorage.getItem('token');
        axios.get('https://recipe-management-n4a8e0net-kautilya-tiwaris-projects.vercel.app/users/allUsers', { headers: { 'authorization': token } })
        .then(response => {
    ...
    function handleFollowButton(userId, button) {
        const token = localStorage.getItem('token');
        axios.post('https://recipe-management-n4a8e0net-kautilya-tiwaris-projects.vercel.app/user/follow', { followedId: userId }, { headers: { 'authorization': token } })
        .then(() => {
    ...
    function loadActivityFeed() {
        ...
        `;
        const token = localStorage.getItem('token');
        axios.get('https://recipe-management-n4a8e0net-kautilya-tiwaris-projects.vercel.app/user/activity-feed', { headers: { 'authorization': token } })
            .then(response => {
